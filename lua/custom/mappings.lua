...
M.general = {
  ...
  n = {
    ...
    -- switch between windows ["<C-h>"] = { "<C-w>h", "window left" }, ["<C-l>"] = { "<C-w>l", "window right" },
...
M.custom = {
  n = {
    ...
    ["<leader>ga"] = {
      function()
        require("nvterm.terminal").send("git add .", "float")
      end,
      "run git add" },
    ["<leader>gp"] = {
      function()
        require("nvterm.terminal").send("catclip ~/github/token && git push --set-upstream origin master", "float")
      end,
      "git push" },  -- This may not work for you because catclip is my own command aand ~/github/token file where my tokein is located :) 
    ["<leader>c"] = {"<cmd>PickColor<cr>"},
    ["<leader>gc"] = {
      function()
        require("nvterm.terminal").send("git commit", "float")
      end,
      "git commits" },
